...
public class Abstraction {
    ...
    Baslangic degil, sonuctur.
       ...
       7) Final methodlar, class’lar override edilemedigi icin, abstract olamazlar.
       (***”final” bir access modifier değildir. "final," bir Java anahtar kelimesidir)

        8) Abstract bir class’in abstract bir child’i olabilir ve abstract child parent’inin
