...
public enum Cities {//new Java class dedikten sonra Enum secenegibi sectik
    ...
    */
    ...
    //private--class disi erisim yok demek, final--field degerinin degistirilemeyecegi anlamina gelir
    private final String cityName;
    private final String postalCode;

    Cities(int plateCode, String cityName, String postalCode) {//constructor olusturduk
        this.plateCode = plateCode;
        this.cityName = cityName;
        this.postalCode = postalCode;
    }

    public int getPlateCode() {//getter methodu ile datalari okumayi sagladik
        return plateCode;
    }
