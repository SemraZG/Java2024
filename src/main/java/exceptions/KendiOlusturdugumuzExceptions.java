...
public class KendiOlusturdugumuzExceptions extends Exception{
    ...
    public KendiOlusturdugumuzExceptions(String message) {
        super(message);//mesaj parentdan geliyor super keyword ile
    }
