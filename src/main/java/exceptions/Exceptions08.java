...
public class Exceptions08 {
    public static void main(String[] args) throws IOException{
        //throws dan virgulle baska exceptionlar da ekleyebiliriz arimetmetik mesela, tekrar throw yazmaya gerek yok
        /**
         1)Runtime Exception:
         Run butonuna bastiktan sonra console'da alinan Exception'lara Runtime Exception denir
         ...
         Code yazarken kirmizi alt cizgi seklinde alinan Exceptionlar’da vardir. Bunlara da Compile Time Exception
        ...
        FileInputStream fis = new FileInputStream("src/main/java/exceptions/file.txt");//dosya yolu parantez icine yazilir
        //herhangi bir sebeple java txt dosyasin ulasamazsa daha calistirmadan altini cizdi ve exception firlatti ne olur olmazsa diye
        //more action dan main methodun yanina throw atti
        //buna compile time exception denir
        ...
        int k = 0; //dosya okumada arka planda Ascii kod kullanildigi icin bu degiskeni olusturduk
        ...
        while ((k=fis.read()) != -1){//ilk dongude J okunur karsiligi 74 olacak asciisi 74 oldugu icin
            //read in alti basta kirmiziydi calistirmadan bile--compile time exception
            // dosyayi bulsam bile okuyamazam yazi bozulmussa diye nolur ne olmaz diye exception firlattirdi
            System.out.print((char)k);// burda k isminde int turundeki degiskeni char turune degistiriyoruz--type casting
        }
